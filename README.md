...
Structural Policy Gradient methods for heterogeneous-agent macro models in general
...
- **`tutorials/`**: the notebooks, the shared `calibration.py`, and the SSJ reference data.
